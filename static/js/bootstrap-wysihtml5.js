!function($, wysi) {
    ...
    var templates = {
		...
		"code":       "<li>" +
                           "<div class='bootstrap-wysihtml5-insert-code-modal modal hide fade'>" +
                               ...
                               "</div>" +
                               "<div class='modal-body'>" +
                                   "<textarea value='http://' class='bootstrap-wysihtml5-insert-code-content' style='width: 510px; height: 200px'></textarea>" +
                               "</div>" +
                               "<div class='modal-footer'>" +
                                   "<a href='#' class='btn' data-dismiss='modal'>Cancel</a>" +
                               ...
                               "</div>" +
                           "</div>" +
                           "<a class='btn' data-wysihtml5-command='insertCode' title='Insert code'><i class='icon-picture'></i></a>" +
                       "</li>",
    ...
    Wysihtml5.prototype = {
      ...
      initInsertCode: function(toolbar) {
            ...
            var urlInput = insertCodeModal.find('.bootstrap-wysihtml5-insert-code-content');
            ...
            var insertCode = function() {
                ...
                //self.editor.composer.commands.exec("insertCode", url);
				alert($("#some-textarea").val())
				$(".wysihtml5-editor").append("<b>zxczxc</b>");
            };
